...
class IndexController extends Controller
{
    ...
    public function home(){
        ...
        $movie_new=Movie::where('category_id',$phim_moi->id)->orderBy('date_update','DESC')->get();

        return view('pages.home',compact('category','genre','country','movie_hot','movie_new'));
    }
    ...
    public function timkiem(){
     ...
     public function category($slug){
        ...
        return view('pages.category',compact('category','genre','country','cate_slug','movie_cate','movie_hot','movie_new'));
    ...
    return view('pages.movie',compact('category','genre','country','movie_slug' ,'movie_info','movie_credits','movie_videos','movie_check','movie_related','episode_current_list_count','episode_first'));
    }
