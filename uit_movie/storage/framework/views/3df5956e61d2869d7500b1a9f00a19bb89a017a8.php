                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        <div class="form-group">
                            ...
                            <?php echo Form::text('title',isset($category)?$category->title:'',['class'=>'form-control my-2',
                        ...
                        <div class='form-group'>
                            ...
                            <?php echo Form::textarea('description',isset($category)?$category->description:'',['style'=>'resize:none','class'=>'form-control my-2','placeholder'=>'Nhap vao du lieu...','id'=>'description']); ?>        
                        </div>
                        <div class='form-group'>
                            <?php echo Form::label('Active','Active',[]); ?>

                            <?php echo Form::select('status',['1'=>"Hien thi", '0'=>'Khong'],isset($category)?$category->status:'',['class'=>'form-control my-2']); ?>        
                        </div>
                    <?php if(!isset($category)): ?>
            ...
            <table class="table">
                ...
                <tbody id="sort_position">
                    ...
                    <tr id="<?php echo e($cate->id); ?>">
                        ...
                        <td class="d-flex">
                            <?php echo Form::open(['method'=>'DELETE','route'=>['category.destroy',$cate->id],'onsubmit'=>'return confirm("Xoa hay khong xoa")']); ?>

                                <?php echo Form::submit('Xoa',['class'=>'btn btn-danger']); ?>

                            <?php echo Form::close(); ?>

                            <a href="<?php echo e(route('category.edit',$cate->id)); ?>" class="btn btn-warning">Sua</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIT_movie\uit_movie\resources\views/admincp/category/form.blade.php ENDPATH**/ ?>