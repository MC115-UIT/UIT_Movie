                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <div class='form-group'>
                            ...
                            <?php echo Form::select('status',['1'=>"Hiển thị", '0'=>'Không'],isset($category)?$category->status:'',['class'=>'form-control my-2']); ?>        
                        </div>
                    <?php if(!isset($category)): ?>
            ...
            <table class="table">
                ...
                <tbody id="sort_position">
                    ...
                    <tr id="<?php echo e($cate->id); ?>">
                        ...
                        <td class="d-flex">
                            <?php echo Form::open(['method'=>'DELETE','route'=>['category.destroy',$cate->id],'onsubmit'=>'return confirm("Xóa hay không xóa")']); ?>
