...
<head>
    ...
    <title>
     ...
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      ...
      <meta property="og:description" content="<?php echo e($movie_slug->description); ?>">
                  ...
                  <div class="tt-details columns is-variable is-8">
                     ...
                     <div class="column main">
                        ...
                        <div class="level genres justify-content-center" style="display:block">
                           ...
                           <div class="level-left">
                              <div class="level-item">
                                 ...
                                 ?>
                                 <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e($current_url); ?>" class="fb-share button is-link" target="_blank">
                                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                              ...
                              <div class="level-item">
                                 <div class="dropdown is-hoverable">
                                       ...
                                       data-uri="<?php echo e($current_url_save); ?>"></div>
                        ...
                        <dl class="horizontal-dl">
                           ...
                           <dt>Quốc gia</dt>
                           <dd class="csv"><a href="<?php echo e(route('country',$movie_slug->country->slug)); ?>"><?php echo e($movie_slug->country->title); ?></a></dd>
                           <dt>Khởi chiếu</dt>
                           <dd><?php echo e(date('d-m-Y', strtotime($movie_slug->date_release))); ?></dd>
                           <dt>Số tập :</dt>
                           <dd class="bg-warning bg-gradient p-2 align-items-center justify-content-center" style="width : 50px; color : black; font-weight: bold"><?php echo e($episode_current_list_count); ?>/<?php echo e($movie_slug->sotap); ?></dd>
                           ...
                           <dd class="list-inline rating align-items-center">
                                 <?php for($count=1; $count<=5; $count++): ?>
                                                    ...
                                                    id="<?php echo e($movie_slug->id); ?>-<?php echo e($count); ?>" 
                                                    
                                                    data-index="<?php echo e($count); ?>"  
                                                    data-movie_id="<?php echo e($movie_slug->id); ?>" 
                                 ...
                                 <?php endfor; ?>
                                 <span class="total_rating pb-3"> (<?php echo e($count_total); ?> lượt)</span>
                           </dd>
                        </dl>
...
<?php /**PATH C:\xampp\htdocs\UIT_movie\uit_movie\resources\views/pages/movie.blade.php ENDPATH**/ ?>