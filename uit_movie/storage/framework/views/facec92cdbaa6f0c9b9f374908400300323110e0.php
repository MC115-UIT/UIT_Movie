...
<html>
  <head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo e(asset('backend/css/bootstrap.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- Custom CSS -->
    ...
    <!-- side nav css file -->
    <link
      href="<?php echo e(asset('backend/css/SidebarNav.min.css')); ?>"
      media="all"
      rel="stylesheet"
      type="text/css"
    />
    <!-- //side nav css file -->
    <!-- js-->
    <script src="<?php echo e(asset('backend/js/jquery-1.11.1.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('backend/js/pie-chart.js')); ?>" type="text/javascript"></script>
    ...
    <link href="<?php echo e(asset('backend/css/owl.carousel.css')); ?>" rel="stylesheet" />
    ...
    <div class="main-content">
          ...
          <nav class="navbar navbar-inverse">
            <div class="navbar-header">
              ...
              <h1>
                <a class="navbar-brand" href="<?php echo e(route('admin')); ?>"
                  ><span class="fa fa-area-chart"></span>UIT Movie<span
            ...
            >
              <ul class="sidebar-menu">
                <li class="header">Quản lí UIT Movie</li>
                <li class="treeview">
                ...
                ?>
                <li class="treeview <?php echo e(($segment=='category')?'active':''); ?>">
                  <a href="#">
                 ...
                 <li class="treeview <?php echo e(($segment=='genre')?'active':''); ?>">
                  <a href="#">
                 ...
                 <li class="treeview <?php echo e(($segment=='country')?'active':''); ?>">
                  <a href="#">
                ...
                <li class="treeview <?php echo e(($segment=='movie')?'active':''); ?>">
                  <a href="#">
               ...
               <!--  <li class="treeview active">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="<?php echo e(route('episode.index')); ?>"
      ...
      <div id="page-wrapper">
        <div class="main-page">
          <div class="col_3">
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong><?php echo e($c_category); ?></strong></h5>
                  <span>Danh mục phim</span>
                </div>
              </div>
            </div>
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong><?php echo e($c_genre); ?></strong></h5>
                  <span>Thể loại phim</span>
                </div>
              </div>
            </div>
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong><?php echo e($c_country); ?></strong></h5>
                  <span>Quốc gia phim</span>
                </div>
              </div>
            </div>
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong><?php echo e($c_movie); ?></strong></h5>
                  <span>Phim</span>
                </div>
              </div>
            </div>
          ...
          <!-- for amcharts js -->
          <script src="<?php echo e(asset('backend/js/amcharts.js')); ?>"></script>
          <script src="<?php echo e(asset('backend/js/serial.js')); ?>"></script>
          <script src="<?php echo e(asset('backend/js/export.min.js')); ?>"></script>
          <link
            rel="stylesheet"
            href="<?php echo e(asset('backend/css/export.css')); ?>"
            type="text/css"
            media="all"
          />
          <script src="<?php echo e(asset('backend/js/light.js')); ?>"></script>
          <!-- for amcharts js -->
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('backend/js/Chart.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/js/utils.js')); ?>"></script>
    <script>
      var MONTHS = [
        'January',
        'February',
    ...
    <script src="<?php echo e(asset('backend/js/SimpleChart.js')); ?>"></script>
    <script>
      var graphdata1 = {
        linecolor: '#CCA300',
        title: 'Monday',
...
<script type="text/javascript">
    $('.category_select').change(function(){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('category-select')); ?>",
            method:"GET",
...
<script type="text/javascript">
    $('.country_select').change(function(){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('country-select')); ?>",
            method:"GET",
            data:{country_id:country_id,movie_id:movie_id},
            success: function(data){
                alert('Thay đổi quốc gia của phim thành công')
            }
        })
    })
</script>
<script type="text/javascript">
    $('.phimhot_select').change(function(){
        var hot_value=$(this).val();
        var movie_id=$(this).attr('id');
        $.ajax({

            url:"<?php echo e(route('phimhot-select')); ?>",
            method:"GET",
            data:{hot_value:hot_value,movie_id:movie_id},
            success: function(data){
                alert('Thay đổi độ hot của phim thành công')
            }
        })
    })
</script>
<script type="text/javascript">
    $('.sub_select').change(function(){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('sub-select')); ?>",
            method:"GET",
            data:{sub_value:sub_value,movie_id:movie_id},
            success: function(data){
                alert('Thay đổi phụ đề của phim thành công')
            }
        })
    })
</script>
<script type="text/javascript">
    $('.status_select').change(function(){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('status-select')); ?>",
            method:"GET",
            data:{status_value:status_value,movie_id:movie_id},
            success: function(data){
                alert('Thay đổi trạng thái của phim thành công')
            }
        })
    })
</script>
...
<script type="text/javascript">
    $('.resolution-select').change(function(){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('resolution-select')); ?>",
            method:"GET",
            data:{res_value:res_value,movie_id:movie_id},
            success: function(data){
                alert('Thay đổi chất lượng của phim thành công')
            }
        })
    })
</script>
...
<?php /**PATH C:\xampp\htdocs\UIT_movie\uit_movie\resources\views/layouts/app.blade.php ENDPATH**/ ?>