          ...
          <div class="col_3">
            <div class="col-md-3 widget widget1">
              <div class="r3_counter_box">
                ...
                <div class="stats">
                  <h5><strong>{{$c_category}}</strong></h5>
                  <span>Danh mục phim</span>
                </div>
              </div>
            </div>
