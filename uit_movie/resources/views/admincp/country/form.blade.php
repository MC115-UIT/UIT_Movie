                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class='form-group'>
                            ...
                            {!!Form::select('status',['1'=>"Hien thi", '0'=>'Khong'],isset($country)?$country->status:'',['class'=>'form-control my-2'])!!}        
                        </div>
                    @if(!isset($country))
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            {!!Form::open(['method'=>'DELETE','route'=>['country.destroy',$cate->id],'onsubmit'=>'return confirm("Xoa hay khong xoa")'])!!}
